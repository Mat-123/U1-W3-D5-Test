...
function whoIsBigger(num1, num2) {
  if (num1 > num2) {
    ...
    console.log("Attenzione i due numeri indicati sono uguali!");
  } else {
...
function splitMe(string) {
  ...
  console.log(.toUpperCase(slicedString));
}
...
console.log("Esercizio 4", deleteOne("Carattere", true));
console.log("Esercizio 4:", deleteOne("Carattere", false));
...
console.log("Esercizio 6:", isThisAnEmail("prova@prova.it"));
...
function isTodayMyBirthday() {
  ...
  const myBirthday = new Date("8/ 20 / 1990");
  return today === myBirthday;
}

console.log("Esercizio 10: oggi e' il mio compleanno?", isTodayMyBirthday());
// Arrays & Oggetti
...
console.log("Esercizio 20:", idContainer);

/* ESERCIZIO 21
  Scrivi una funzione per selezionare ogni tag <td> all'interno della pagina.
*/

const tdTagSelector = document.getElementsByTagName("td");
console.log("Esercizio 21:", tdTagSelector);

/* ESERCIZIO 22
  Scrivi una funzione che, tramite un ciclo, stampa in console il testo contenuto in ogni tag <td> all'interno della pagina.
*/
function tdTagPrinter() {
  for (let i = 0; i < tdTagSelector.length; i++) {
    const element = tdTagSelector[i].innerText;
    return element;
  }
}

console.log(tdTagPrinter());
/* ESERCIZIO 23
  Scrivi una funzione per aggiungere un background di colore rosso a ogni link all'interno della pagina.
*/
function changeColorToA() {
  const aBackgroundSwitch = document.getElementsByTagName("a");
  aBackgroundSwitch.style = "backgroundcolor: red";
  return aBackgroundSwitch;
}
